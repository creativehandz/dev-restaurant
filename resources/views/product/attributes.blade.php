  ...
  <header class="card-header">
    ...
    <div class="col-12 col-md-5">
      ...
      <div class="col-12 col-md-7 d-flex flex-column flex-md-row justify-content-end gap-2">
        <input type="search" class="form-control custom-input-btn m-2" placeholder="Search by Category Name">
        <button type="submit" id="getsearch" class="btn btn-light custom-btn text-dark hover:text-dark m-2">Search</button>
        <button type="submit" id="getsearch" class="btn btn-success custom-btn  hover:text-dark m-2">+ Add Attribute</button>
      </div>
    </div>
  </header>   
  <div class="card-body">
